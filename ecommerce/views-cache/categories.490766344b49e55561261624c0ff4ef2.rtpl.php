          ...
          <div class="box-header">
            ...
            <div class="box-tools">
              <form action="/admin/categories">
                <div class="input-group input-group-sm" style="width: 35vw;">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="/admin/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"
                      onclick="return confirm('Deseja realmente excluir a categoria <?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?')"
